            ...
            if (!this.$globalData.userInfo.nickname) {
                this.$api.getUserInfo().then(res => {
                    if (res.data.status_code === 1) {
                        res.data.data.signInTime = res.data.data.signInTime.substring(0, 10);
        ...
        methods: {
                ...
                this.$api.getMyFavorite().then(res=>{
                    ...
                    if (res.data.status_code === 1){
                        for (let i = 0; i < res.data.data.length; i++) {
                            let pictureList = JSON.parse(res.data.data[i].idleItem.pictureList);
                            this.dataList[2].push({
                                favoriteId:res.data.data[i].id,
                                id:res.data.data[i].idleItem.id,
                                imgUrl:pictureList.length > 0 ? pictureList[0] : '',
                                idleName:res.data.data[i].idleItem.idleName,
                                idleDetails:res.data.data[i].idleItem.idleDetails,
                                timeStr:res.data.data[i].createTime.substring(0, 10) + " " + res.data.data[i].createTime.substring(11, 19),
                                idlePrice:res.data.data[i].idleItem.idlePrice
                            });
                        }
                    }
                })
            ...
            getMySoldIdle(){
                this.$api.getMySoldIdle().then(res=>{
                    if (res.data.status_code === 1){
                        console.log('getMySoldIdle',res.data.data);
                        for (let i = 0; i < res.data.data.length; i++) {
                            let pictureList = JSON.parse(res.data.data[i].idleItem.pictureList);
                            this.dataList[3].push({
                                ...
                                idleDetails:res.data.data[i].idleItem.idleDetails,
                                timeStr:res.data.data[i].createTime.substring(0, 10) + " " + res.data.data[i].createTime.substring(11, 19),
                                idlePrice:res.data.data[i].orderPrice,
            ...
            getIdleItemData() {
                this.$api.getAllIdleItem().then(res => {
                    ...
                    if (res.data.status_code === 1) {
                        for (let i = 0; i < res.data.data.length; i++) {
                            res.data.data[i].timeStr = res.data.data[i].releaseTime.substring(0, 10) + " " + res.data.data[i].releaseTime.substring(11, 19);
                            let pictureList = JSON.parse(res.data.data[i].pictureList);
                            res.data.data[i].imgUrl = pictureList.length > 0 ? pictureList[0] : '';
                            if (res.data.data[i].idleStatus === 1) {
                                this.dataList[0].push(res.data.data[i]);
                            } else if (res.data.data[i].idleStatus === 2) {
                                this.dataList[1].push(res.data.data[i]);
                            }
                        }
                    }
                })
